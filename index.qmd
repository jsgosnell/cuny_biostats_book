...
This book is meant to accompany BIO/ENV 2100:Biostatistics at Baruch
College, but it should offer another perspective to anyone trying to
learn statistics, R, or some combination. The class now includes
...
list of additional resources).To this I offer a few responses
...
-   The courses I teach focus on introducing statistics from a
    ...
    should aid in helping students learn to understand why various tests
...
-   we'll learn how to use tools and applications including R (through
    ...
    -   I typically use verbose coding (more words and lines, but easier
        ...
        readability (which is connected to repoducibility) for our
        fields
...
did appear on maps!](images/Carta_Marina.jpeg){#fig-dragon_map
