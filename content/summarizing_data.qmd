...
colors, or other features to symbolize the groups. We also need to
ensure the different groups are visible when distributions overlap.

```{r}
#| label: bar_charts_all species
...
```{r}
#| label: stacked_histograms_all species
#| fig-cap: "Note the top of the bar is the mean (we'll get there!) for each group!"
