...
F-distribution is the ration of two $\chi^2$ distributions, which are
sums of squared Z distributions. The t distribution is the special case
where you can take the square of an F distribution where the numerator
(top) $\chi^2$ distribution has 1 degree of freedom and the denomintor
(bottom) has n-1 degrees of freedom. In general, variance follows a
...
In older text books, you would have a t-table that showed p-values for
multiple scores and multiple degrees of freedom. We can actually produce
one in R.
