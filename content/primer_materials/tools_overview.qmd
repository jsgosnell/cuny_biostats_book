...
Below are notes to help you download these and get started.
...
link!)](/images/repository_select.png){alt="Find your repository @ https://github.com/settings/repositories. Then select it (use the top link!)"
fig-alt="Image of github repositories listed @ https://github.com/settings/repositories for an example user.  One of the repositories is circled."}
...
option.](/images/sync_fork.png){alt="You can sync up any changes to the original assignment repository by clicking the sync fork button. Note all repositories will not have this option."
fig-alt="Image of github repository screen. Since this repository was forked (this time via github classroom) you can press the sync fork button (circled in red) to  sync up any changes to the original assignment repository"}
...
url](/images/github%20screen.jpg){alt="Click on Code to get repository url"
fig-alt="Image of github repository screen. Yellow circle around green Code button in upper right corner."}
...
repository.](/images/rstudio%20screen.jpg){alt="Click on New Project to clone a repository."
fig-alt="Image of Rstudio cloud home screen.  Yellow circle around New Project button in upper right corner."}
...
project](/images/file_new_project.jpg){alt="Select File > New Project in Rstudio to start a project"
fig-alt="Image of Rstudio screen.  File button in upper left corner is  circled."}
...
to](/images/credential_error.jpg){alt="This screen means you need to tell your computer who to assign changes to"
fig-alt="Image of common git error. Pop-up is titled Git Commit and states ***Please tell me who you are.***. Following lines offer instructions that are detailed below."}
...
computer](https://lh3.googleusercontent.com/pw/ACtC-3dm7BlCVoK7RYCQS-sB66LWveip4Hude5tmpeALZEMJm_nR1AKVP_R-1SON-7JrvBPNZb28HWBFax2SqRCtf1iJNNUXBrTg6UupRMJhRPZIGWHy1a3QXgQYlwipDxyg0T6K4I7Q5jTVwamUfwgSBfBcpQ=w462-h228-no?authuser=0){alt="The terminal tab lets you send commands to your computer"
...
window.](/images/pat page.png){fig-alt="Image of github personal access token creation page."}
...
A window should appear. When it's done (white text shows) go to your
github repository (on the web). Open the folder for this assignment and
click on the .md file. It should preview, and you should see the updated
file with your name! Congratulations!
