...
year). For juncos, 4 of 11 sampled birds were older. Before we test
this, we need to decide on an hypothesis. Although both species were
predicted to occur at 3:1 ratios in the wild, that's not what we are
considering here. Instead, we want to know if the likelihood of old vs
young birds being in our samples differed for the species. If so, it
could be because the age structure of the focal populations are
...
Put another way,we want to test if *p* is independent of species. This
formulation is important, because it helps form our predictions under
the null hypothesis. For our sample, we have 11 juncos and 18 cardinals.

|           |              |           |        |
|-----------|--------------|-----------|--------|
|           | **Cardinal** | **Junco** | Totals |
| **Old**   | 9            | 4         | 13     |
| **Young** | 9            | 7         | 16     |
| Totals    | 18           | 11        |        |
