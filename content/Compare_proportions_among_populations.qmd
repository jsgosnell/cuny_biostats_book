...
Commons](/images/Dark-eyed_Junco_(Oregon)_(39651044095).jpg){fig-alt="Dark-eyed Junco (Junco hyemalis), Sobrante Ridge Regional Reserve, Richmond, California."}](https://commons.wikimedia.org/wiki/File:Dark-eyed_Junco_%28Oregon%29_%2839651044095%29.jpg)

Let's start simple and just compare purple finches and dark-eyed juncos.

[![Becky Matsubara from El Sobrante, California, CC BY 2.0 <https://creativecommons.org/licenses/by/2.0>, via Wikimedia Commons\>, via Wikimedia
...
|                |           |           |             |
|----------------|-----------|-----------|-------------|
|                | **Finch** | **Junco** | *Row total* |
| **Old**        | 18\*13/29 | 11\*13/29 | 13          |
| **Young**      | 18\*16/29 | 11\*13/29 | 16          |
| *Column total* | 18        | 11        |             |
...
```{r}
library(reshape2) 
birds_wide <- dcast(birds_original, Age~Species) birds_wide)
```
...
`{r} chisq.test(matrix(c(birds_wide$Finch, birds_wide$Junco), nrow = 2))}`
