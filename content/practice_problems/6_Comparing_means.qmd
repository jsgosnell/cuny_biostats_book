...
Before doing this, review the **6. Comparing means** lecture set slides
from
<https://sites.google.com/view/biostats/lessons/comparing-means-among-groups>
and the **7_ANOVAs.R** script in the lecture files folder of the
...
5.  The following data are human blood clotting times (in minutes) of
...
6.  (Example from Handbook on Biological Statistics) Odd (stunted,
