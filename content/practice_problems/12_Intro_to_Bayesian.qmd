...
Using [linked data from Australian athletes](https://gksmyth.github.io/ozdasl/oz/ais.html){target="_blank"}
 for details), determine
...
approach, compare approaches that give the null more and less weight.
