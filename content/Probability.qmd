...
|       |       | 1     | 2     | 3     | 4     | 5     | 6     |
+-------+-------+-------+-------+-------+-------+-------+-------+
| **S   | 1     | (1,1) | (1,2) | (1,3) | **(1  | (1,5) | (1,6) |
| econd |       |       |       |       | ,4)** |       |       |
| D     |       |       |       |       |       |       |       |
| ice** |       |       |       |       |       |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
|       | 2     | (2,1) | (2,2) | **(2  | (2,4) | (2,5) | (2,6) |
|       |       |       |       | ,3)** |       |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
...
$$
P[being \ cured|medicine] = \frac{P[receiving \ medicine|cured]P[being \ cured]}{P[receiving \ medicine]} \\
P[being \ cured|medicine] = \frac{.8 * .5}{.5} \\
P[being \ cured|medicine] = .8
...
Commons](https://upload.wikimedia.org/wikipedia/commons/7/75/PPV%2C_NPV%2C_Sensitivity_and_Specificity.pdf){fig-align="center"}
