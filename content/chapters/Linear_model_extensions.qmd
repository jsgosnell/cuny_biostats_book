...
but also common practice. Ignored here is their first main point - the
model must be valid! As noted in the multiple regression chapter, we
only should investigate relationships we have a mechanism to explain. We
will return to this point multiple times
