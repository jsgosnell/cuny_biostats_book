...
Logistic regression focused on yes/no or success/failure outcomes; data
can be a single answer (Bernoulli) or a collection (binomial).

##### Beta regression

Beta regression focuses on true proportion data where the outcome is between 
0 and 1.
