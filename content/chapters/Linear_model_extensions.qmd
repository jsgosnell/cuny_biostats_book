...
consider data that do not fit a normal approximation.

| Family             | Typical usage                                                                                                                                     |
|--------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|
...
| Poisson            | Count data where low counts and 0's are common                                                                                                    |

: Connections between exponential family data types and real-world data
