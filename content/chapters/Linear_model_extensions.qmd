...
time...but look at the graphed data.

```{r}
library(plyr)
library(Hmisc)
wasp$Duration <- revalue(wasp$Duration, c("C"="0", "L"="72", "S"="6"))
wasp$Duration <- factor(wasp$Duration, levels = c("0", "6", "72"))
ggplot(wasp, aes(x=Duration, y=develop_time))+
  geom_jitter()+
