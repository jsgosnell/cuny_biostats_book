...
@gelman2006. Ignored here is their first main point - the model must be
valid! As noted in the multiple regression chapter, we only should
...
(e.g., square) or strictly positive (e..g., log) values. To address this
for log transformations, a small value is often added to 0 measurements.
