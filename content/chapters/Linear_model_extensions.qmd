...
Note if you use top-down selection procedures on mixed-effects models,
you'll need to ensure to use the maximum-likelihood method to refit each
model (not restricted maximum-likelihood).
