...
A useful command to know going forward is the *vif* function to check the correlation of your variables. For example, here is a dataframe based on the "USArrests" dataset
```{r}
