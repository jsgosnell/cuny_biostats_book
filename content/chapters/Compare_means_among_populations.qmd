...
H_A: \textrm{all means are not equal to each other;at least one mean is different than the others(a little odd to write matehmatically!)}\\ 
\end{split}
$$
...
degrees of freedom j-1 (# of groups - 1) and the numerator had degrees
