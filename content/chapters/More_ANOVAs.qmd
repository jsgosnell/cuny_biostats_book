...
```{r}
valdez_2003 <- read.csv("data/Spartina_alterniflora_traits.csv")
valdez_model <-lm(below.biomass..g.~Snail.Level + Nitrogen.level + Snail.Level:Nitrogen.level, valdez_2003)
```
