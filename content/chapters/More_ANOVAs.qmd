...
colnames(smoking_data) <- c("Year", "Injuries before No Smoking Day", "Injuries on No Smoking Day")
```
...
```{r}
smoking_data$difference = smoking_data$InjuriesonNoSmokingDay - smoking_data$InjuriesbeforeNoSmokingDay
```
