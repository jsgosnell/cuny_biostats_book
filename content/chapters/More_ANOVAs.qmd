...
```{r}
valdez_2003 <- read.csv("./data/Spartina_ alterniflora_Traits.csv")
```

```{r}
library(readr)
Spartina_alterniflora_Traits <- read_csv("data/Spartina_ alterniflora_Traits.csv")
View(Spartina_alterniflora_Traits)
```
