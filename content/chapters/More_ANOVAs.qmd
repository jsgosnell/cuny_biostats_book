...
<details><summary> Experimental design notes</summary>
...
```{r}
example_interaction <- data.frame(Treatment = c(rep("Control",6),
                                                rep("Impact of A only",6),
                                                rep("Impact of B only",6),
                                                rep("A+B Additive",6), 
                                                rep("A+B Synergistic", 6),
                                                rep("A+B Antagonistic", 6)), 
                                  Cause= rep(c("Control","Factor A","Factor B", "Additive", "Synergistic", "Antagonistic"), 6),
                                  Impact = c(5,0,0,0,0,0,
                                             5,2,0,0,0,0,
                                             5,0,3,0,0,0,
                                             5,2,3,0,0,0,
                                             5,2,3,0,10,0,
...
example_interaction$Cause <- factor(example_interaction$Cause, levels=c("Control","Factor A","Factor B", "Additive", "Synergistic", "Antagonistic"))
