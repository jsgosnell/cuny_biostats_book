...
paged_table(bonf_correct[bonf_correct$Comparison=="Finch : Catbird", "p.Chisq"])
...
Alternatively, you can consider summing up the smallest p-values
associated with the pairs of tests until the cumulative sum is as close
as you can get to $\alpha$.
