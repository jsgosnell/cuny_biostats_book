...
predictor variables. The **pairs** function is one way to do this:
...
their interactions) until all are "significant". You can do this
...
(which happens immediately here). This approach requires nested models
