...
determine how many ways one can arrange *s* successes in *n* draws. It
can be written as
...
|          |                         |                                                        |                                                     |
|----------|-------------------------|--------------------------------------------------------|-----------------------------------------------------|
|          | **Two-sided (typical)** | **Focused on signals greater than predicted in null**  | **Focused on signals less than predicted in null**  |
| **H~O~** | p = C                   | p \<= C                                                | p \>= C                                             |
| **H~A~** | p $\neq$ C              | p \> C                                                 | p \< C                                              |
...
*binom* package gives multiple options. For the function,
