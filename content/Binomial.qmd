...
explain the concept
\[here\](https://www.youtube.com/watch?v=bz9nzc-jVEE&t=4s).
...
proportion_observed = data.frame(Proportion = 9/18, Probability = .5)
ggplot(finches, aes(x = Proportion, y = Probability)) + 
  geom_bar(stat="identity", aes(fill = criteria)) + 
  geom_segment(x = .29031, xend = .70968,y= .5 , yend =.5, size = 2) +
