...
```{r}
read.table("https://raw.githubusercontent.com/jsgosnell/CUNY-BioStats/refs/heads/master/datasets/cane.txt", header = T, stringsAsFactors = T)
```

More info on the data can be found at
<https://gksmyth.github.io/ozdasl/oz/cane.html>. Is there evidence that
location (DistrictPosition column) impacts yield (Tonn.Hect column)? If
so, which areas are driving this distance?

```{r}
cane <- read.table("https://raw.githubusercontent.com/jsgosnell/CUNY-BioStats/refs/heads/master/datasets/cane.txt", header = T, stringsAsFactors = T)
summary(cane)
