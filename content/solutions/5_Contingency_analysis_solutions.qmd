...
*I looked at the data and then just made a table manually, focusing on
...
Data on smoking and exercise were collected (from
http://www.r-tutor.com/elementary-statistics/goodness-fit/chi-squared-test-independence)
to determine if smoking is independent of exercise.

|               |                    |      |      |
|---------------|--------------------|------|------|
|               | **Exercise Level** |      |      |
| Smoking Level | Frequent           | None | Some |
| Heavy         | 7                  | 1    | 3    |
| Never         | 87                 | 18   | 84   |
| Occasional    | 12                 | 3    | 4    |
| Regular       | 9                  | 1    | 7    |

You’ll need to input data manually. Carry out post-hoc tests if needed.
