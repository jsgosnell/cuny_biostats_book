...
https://raw.githubusercontent.com/jsgosnell/CUNY-BioStats/refs/heads/master/datasets/ms212.txt

With more info at 

http://gksmyth.github.io/ozdasl/oz/ms212.html.
...
```{r}
pulse <- read.table("https://raw.githubusercontent.com/jsgosnell/CUNY-BioStats/refs/heads/master/datasets/ms212.txt", header = T, stringsAsFactors = T)
...
2. (from OZDASL repository,https://gksmyth.github.io/ozdasl/general/stature.html; reference for more information)
...
https://raw.githubusercontent.com/jsgosnell/CUNY-BioStats/refs/heads/master/datasets/stature.txt
...
```{r}
height <- read.table("https://raw.githubusercontent.com/jsgosnell/CUNY-BioStats/refs/heads/master/datasets/stature.txt", 
...
https://raw.githubusercontent.com/jsgosnell/CUNY-BioStats/refs/heads/master/datasets/medals.txt

More information on the data can be found at: 

https://gksmyth.github.io/ozdasl/oz/medals.html

Is there any relationship between a country’s population and the total
number of medals they win?

```{r}
medals <- read.table(header = T, "https://raw.githubusercontent.com/jsgosnell/CUNY-BioStats/refs/heads/master/datasets/medals.txt", 
                     stringsAsFactors = T)
head(medals)
...
<https://raw.githubusercontent.com/jsgosnell/CUNY-BioStats/refs/heads/master/datasets/fev.txt>

More information on the dataset is available at 

<https://perso.univ-rennes1.fr/bernard.delyon/tp/fev.html>
...
```{r}
fev <- read.table("https://raw.githubusercontent.com/jsgosnell/CUNY-BioStats/refs/heads/master/datasets/fev.txt", header = T, 
                  stringsAsFactors = T)
head(fev)
