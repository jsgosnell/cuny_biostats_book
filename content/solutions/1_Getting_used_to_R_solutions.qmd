...
[(see help file)](content/Primer_material/Tools_overview.html).
...
Is `-1:2` the same as `(-1):2` or `-(1:2)`? INSERT AN R CHUNK HERE AND RUN EACH OF 
...
Sometimes data doesn’t have headers (column names),so you have to add them.
