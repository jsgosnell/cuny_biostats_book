...
https://raw.githubusercontent.com/jsgosnell/CUNY-BioStats/refs/heads/master/datasets/insulgas.txt

More information on the data is available @

https://gksmyth.github.io/ozdasl/general/insulgas.html
...
```{r}
heat <- read.table("https://raw.githubusercontent.com/jsgosnell/CUNY-BioStats/refs/heads/master/datasets/insulgas.txt", 
...
https://raw.githubusercontent.com/jsgosnell/CUNY-BioStats/refs/heads/master/datasets/cherry.txt

Use the data to justify an optimal model.

```{r}
cherry <- read.table("https://raw.githubusercontent.com/jsgosnell/CUNY-BioStats/refs/heads/master/datasets/cherry.txt",
                     header = T)
head(cherry)
