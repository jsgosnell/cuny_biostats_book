...
give us estimates about how the real world works. Put another way, if we knew
...
Over the course of the semester, our (ambitious) goals are to
...
Points")+ ylab("Species number")+ scale_y\_continuous(breaks =
...
number")+ scale_y\_continuous(breaks =
pretty(vegSurvey$sppInv),labels = abs(pretty(vegSurvey$sppInv)))+
theme(strip.text.x = element_text(face = "bold"))
...
scale_y\_continuous(sec.axis = sec_axis(\~.-50, name = "Wind (mph)")) +
