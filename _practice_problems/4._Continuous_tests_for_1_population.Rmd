...
Before doing this, review the **Introduction to normality and one-sample tests for continuous data** lecture set slides from 
...
2. Review the central_limit_theorem.R code (remember
